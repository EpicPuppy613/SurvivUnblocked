...
aiptag.settings = {
	...
	sPubName: 'SRV',
	sPubUrl: 'surviv.io',
	sAdUnitVideo: 'surviv.io_preroll',
	sRewardedAdUnitVideo: '',
	sRewardAdUnitVideoFallback: '',
	iTimeoutBidDisplay: 900,
	iTimeoutBidPlayer: 1500,
	sNetworkIdRewarded: '421469808',
	iForceGdprShowConsentTool: false,
	sForceGdprConsentToolPosition: 'center',
	...
	iHideBranding: false,
	iAmazonAds: true,
	sNetworkIdVideo: '421469808',
	sNetworkIdDisplay: '421469808',
	iAdFading: true,
	iDFPAdSlots: true,
	iVideoAdUnitBidders: true,
	iDisableEvenAddRefresh: false,
	iAutoRefreshBanners: false,
	iAutoRefreshBannersViewPercentage: false,
	iAutoRefreshBannersTimeout: false,
	sCustomDisplayBidCpmAdjustment: {
"gumgum": {"surviv-io_300x250": 0.73, "surviv-io_728x90": 0.62}
}
};
...
function aipAPI() {
	//console info
	try{
		var e = ["\n %c %c %c AdinPlay v"+aiptag.settings.sVersion+" ✰ "+aiptag.settings.sPubName+" ✰ "+aip_pbjs.version+" %c  %c  ads by http://www.adinplay.com/  %c %c %c%c \n\n", "background: #9C0013; padding:5px 0;", "background: #9C0013; padding:5px 0;", "color: #FFFFFF; background: #030307; padding:5px 0;", "background: #9C0013; padding:5px 0;", "color: #FFFFFF;background: #DB0028; padding:5px 0;", "background: #9C0013; padding:5px 0;", "color: #ff2424; background: #fff; padding:5px 0;", "color: #ff2424; background: #fff; padding:5px 0;", "color: #ff2424; background: #fff; padding:5px 0;"];

		//var e = ["\n %c %c %c %c AdinPlay v"+aiptag.settings.sVersion+" ✰ "+aiptag.settings.sPubName+" ✰ "+aip_pbjs.version+" ✰  %c  %c  ads by http://www.adinplay.com/  %c %c %c %c \n\n", 'background:url("https://api.adinplay.com/libs/aiptag/assets/console-adinplay-logo.png");padding:30px 115px;background-repeat:no-repeat;', "background: #9C0013; padding:5px 0;", "background: #9C0013; padding:5px 0;", "color: #FFFFFF; background: #030307; padding:5px 0;", "background: #9C0013; padding:5px 0;", "color: #FFFFFF;background: #DB0028; padding:5px 0;", "background: #9C0013; padding:5px 0;", "color: #ff2424; background: #fff; padding:5px 0;", "color: #ff2424; background: #fff; padding:5px 0;", "color: #ff2424; background: #fff; padding:5px 0;"];
	...
	if (this.forceUserFrom === true) {
		this.userFromEEA = true;
	}
	
	if(aiptag.settings.iForceGdprShowConsentTool) {
		aiptag.gdprShowConsentTool = true;
		aiptag.gdprConsentToolPosition = aiptag.settings.sForceGdprConsentToolPosition;
	}
	
	if(aiptag.settings.iVideoAdUnitBidders) {
		this.videoAdUnit = [];
		this.videoAdUnit["surviv.io_preroll"] = {
code: 'prerollUnit',
mediaTypes: {
	video: {
		context: 'instream',
...
bids: [
	...
	},
	{
		...
		this.adUnits['surviv-io_728x90'] = [{
		code: 'surviv-io_728x90',
		mediaTypes: {
			banner: {
				sizes: [728, 90]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					publisherId: '156857',
					adSlot: '1410205@728x90'
				}
			},
			{
				bidder: 'ix',
				params: { siteId: '254671', size: [728, 90] }
			},
			{
				bidder: 'sovrn',
				params: { tagid: '639474' }
	...
	this.adSlots['surviv-io_728x90'] = {adunit: 'surviv.io_728x90', sizes: [728, 90], reload: true};
		this.adUnitsAps['surviv-io_728x90'] = [{slotID: 'surviv-io_728x90', slotName: '/421469808/surviv.io_728x90', sizes: [[728, 90]]}];
		this.requestManager['surviv-io_728x90'] = {adserverRequestSent: false, aps: false, prebid: false};

		this.adUnits['surviv-io_300x250'] = [{
		code: 'surviv-io_300x250',
		mediaTypes: {
			banner: {
				sizes: [300, 250]
			}
		...
		bids: [
			{
				bidder: 'appnexus',
				params: { placementId: '12783007' }
			},
			{
				bidder: 'ix',
				params: { siteId: '254295', size: [300, 250] }
			},
			{
				bidder: 'openx',
				params: {
			...
			},
			{
				...
				params: {
					publisherId: '156857',
					adSlot: '1410188@300x250'
				}
			},
			{
				bidder: 'rhythmone',
				params: { placementId: '79123' }
			},
			{
				bidder: 'gumgum',
				params: { inSlot: '20523' }
	...
	this.adSlots['surviv-io_300x250'] = {adunit: 'surviv.io_300x250', sizes: [300, 250], reload: true};
		this.adUnitsAps['surviv-io_300x250'] = [{slotID: 'surviv-io_300x250', slotName: '/421469808/surviv.io_300x250', sizes: [[300, 250]]}];
		this.requestManager['surviv-io_300x250'] = {adserverRequestSent: false, aps: false, prebid: false};

		this.adUnits['surviv-io_300x250_2'] = [{
		code: 'surviv-io_300x250_2',
		mediaTypes: {
			banner: {
				sizes: [300, 250]
			}
		...
		bids: [
			{
				bidder: 'appnexus',
				params: { placementId: '12858428' }
			},
			{
				bidder: 'ix',
				params: { siteId: '254832', size: [300, 250] }
			},
			{
				bidder: 'openx',
				params: {
	...
	this.adSlots['surviv-io_300x250_2'] = {adunit: 'surviv.io_300x250_2', sizes: [300, 250], reload: true};
		this.adUnitsAps['surviv-io_300x250_2'] = [{slotID: 'surviv-io_300x250_2', slotName: '/421469808/surviv.io_300x250_2', sizes: [[300, 250]]}];
		this.requestManager['surviv-io_300x250_2'] = {adserverRequestSent: false, aps: false, prebid: false};

		this.adUnits['surviv-io_300x250_3'] = [{
		code: 'surviv-io_300x250_3',
		mediaTypes: {
			banner: {
				sizes: [300, 250]
			}
		...
		bids: [
			{
				bidder: 'appnexus',
				params: { placementId: '18438446' }
			},
			{
				bidder: 'ix',
				params: { siteId: '460479', size: [300, 250] }
			},
			{
				bidder: 'openx',
				params: {
	...
	this.adSlots['surviv-io_300x250_3'] = {adunit: 'surviv.io_300x250_3', sizes: [300, 250], reload: true};
		this.adUnitsAps['surviv-io_300x250_3'] = [{slotID: 'surviv-io_300x250_3', slotName: '/421469808/surviv.io_300x250_3', sizes: [[300, 250]]}];
		this.requestManager['surviv-io_300x250_3'] = {adserverRequestSent: false, aps: false, prebid: false};

		this.adUnits['surviv-io_300x250_4'] = [{
		code: 'surviv-io_300x250_4',
		mediaTypes: {
			banner: {
				sizes: [300, 250]
			}
		...
		bids: [
			{
				bidder: 'appnexus',
				params: { placementId: '18438445' }
			},
			{
				bidder: 'ix',
				params: { siteId: '460480', size: [300, 250] }
			},
			{
				bidder: 'openx',
				params: {
	...
	this.adSlots['surviv-io_300x250_4'] = {adunit: 'surviv.io_300x250_4', sizes: [300, 250], reload: true};
		this.adUnitsAps['surviv-io_300x250_4'] = [{slotID: 'surviv-io_300x250_4', slotName: '/421469808/surviv.io_300x250_4', sizes: [[300, 250]]}];
		this.requestManager['surviv-io_300x250_4'] = {adserverRequestSent: false, aps: false, prebid: false};

		this.adUnits['surviv-io_300x250_mobile'] = [{
		code: 'surviv-io_300x250_mobile',
		mediaTypes: {
			banner: {
				sizes: [300, 250]
			}
		...
		bids: [
			{
				bidder: 'appnexus',
				params: { placementId: '13075369' }
			}
		]
	}];
	this.adSlots['surviv-io_300x250_mobile'] = {adunit: 'surviv.io_300x250_mobile', sizes: [300, 250], reload: true};
		this.adUnitsAps['surviv-io_300x250_mobile'] = [{slotID: 'surviv-io_300x250_mobile', slotName: '/421469808/surviv.io_300x250_mobile', sizes: [[300, 250]]}];
		this.requestManager['surviv-io_300x250_mobile'] = {adserverRequestSent: false, aps: false, prebid: false};

		this.adUnits['surviv-io_300x250_mobile_2'] = [{
		code: 'surviv-io_300x250_mobile_2',
		mediaTypes: {
			banner: {
				sizes: [300, 250]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					publisherId: '156857',
					adSlot: '1429408@300x250'
				}
			},
			{
				bidder: 'ix',
				params: { siteId: '321921', size: [300, 250] }
			},
			{
				bidder: 'rhythmone',
				params: { placementId: '79123' }
	...
	this.adSlots['surviv-io_300x250_mobile_2'] = {adunit: 'surviv.io_300x250_mobile_2', sizes: [300, 250], reload: true};
		this.adUnitsAps['surviv-io_300x250_mobile_2'] = [{slotID: 'surviv-io_300x250_mobile_2', slotName: '/421469808/surviv.io_300x250_mobile_2', sizes: [[300, 250]]}];
		this.requestManager['surviv-io_300x250_mobile_2'] = {adserverRequestSent: false, aps: false, prebid: false};

		this.adUnits['surviv-io_300x250_leaderboard'] = [{
		code: 'surviv-io_300x250_leaderboard',
		mediaTypes: {
			banner: {
				sizes: [300, 250]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					publisherId: '156857',
					adSlot: '1423406@300x250'
				}
			}
		]
	}];
	this.adSlots['surviv-io_300x250_leaderboard'] = {adunit: 'surviv.io_300x250_leaderboard', sizes: [300, 250], reload: true};
		this.adUnitsAps['surviv-io_300x250_leaderboard'] = [{slotID: 'surviv-io_300x250_leaderboard', slotName: '/421469808/surviv.io_300x250_leaderboard', sizes: [[300, 250]]}];
		this.requestManager['surviv-io_300x250_leaderboard'] = {adserverRequestSent: false, aps: false, prebid: false};

		this.adUnits['surviv-io_300x250_playerprofile'] = [{
		code: 'surviv-io_300x250_playerprofile',
		mediaTypes: {
			banner: {
				sizes: [300, 250]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					publisherId: '156857',
					adSlot: '1423409@300x250'
				}
			}
		]
	}];
	this.adSlots['surviv-io_300x250_playerprofile'] = {adunit: 'surviv.io_300x250_playerprofile', sizes: [300, 250], reload: true};
		this.adUnitsAps['surviv-io_300x250_playerprofile'] = [{slotID: 'surviv-io_300x250_playerprofile', slotName: '/421469808/surviv.io_300x250_playerprofile', sizes: [[300, 250]]}];
		this.requestManager['surviv-io_300x250_playerprofile'] = {adserverRequestSent: false, aps: false, prebid: false};

		this.adUnits['surviv-io_728x90_Leaderboard'] = [{
		code: 'surviv-io_728x90_Leaderboard',
		mediaTypes: {
			banner: {
				sizes: [728, 90]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					publisherId: '156857',
					adSlot: '1423404@728x90'
				}
			}
		]
	}];
	this.adSlots['surviv-io_728x90_Leaderboard'] = {adunit: 'surviv.io_728x90_Leaderboard', sizes: [728, 90], reload: true};
		this.adUnitsAps['surviv-io_728x90_Leaderboard'] = [{slotID: 'surviv-io_728x90_Leaderboard', slotName: '/421469808/surviv.io_728x90_Leaderboard', sizes: [[728, 90]]}];
		this.requestManager['surviv-io_728x90_Leaderboard'] = {adserverRequestSent: false, aps: false, prebid: false};

		this.adUnits['surviv-io_728x90_playerprofile'] = [{
		code: 'surviv-io_728x90_playerprofile',
		mediaTypes: {
			banner: {
				sizes: [728, 90]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					publisherId: '156857',
					adSlot: '1423412@728x90'
				}
			}
		]
	}];
	this.adSlots['surviv-io_728x90_playerprofile'] = {adunit: 'surviv.io_728x90_playerprofile', sizes: [728, 90], reload: true};
		this.adUnitsAps['surviv-io_728x90_playerprofile'] = [{slotID: 'surviv-io_728x90_playerprofile', slotName: '/421469808/surviv.io_728x90_playerprofile', sizes: [[728, 90]]}];
		this.requestManager['surviv-io_728x90_playerprofile'] = {adserverRequestSent: false, aps: false, prebid: false};

		this.adUnits['surviv-io_300x250_webview'] = [{
		code: 'surviv-io_300x250_webview',
		mediaTypes: {
			banner: {
				sizes: [300, 250]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					publisherId: '156857',
					adSlot: '1674843@300x250'
				}
			}
		]
	}];
	this.adSlots['surviv-io_300x250_webview'] = {adunit: 'surviv.io_300x250_webview', sizes: [300, 250], reload: true};
		this.adUnitsAps['surviv-io_300x250_webview'] = [{slotID: 'surviv-io_300x250_webview', slotName: '/421469808/surviv.io_300x250_webview', sizes: [[300, 250]]}];
		this.requestManager['surviv-io_300x250_webview'] = {adserverRequestSent: false, aps: false, prebid: false};

		this.adUnits['surviv-io_300x250_webview_2'] = [{
		code: 'surviv-io_300x250_webview_2',
		mediaTypes: {
			banner: {
				sizes: [300, 250]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					publisherId: '156857',
					adSlot: '1674849@300x250'
				}
			}
		]
	}];
	this.adSlots['surviv-io_300x250_webview_2'] = {adunit: 'surviv.io_300x250_webview_2', sizes: [300, 250], reload: true};
		this.adUnitsAps['surviv-io_300x250_webview_2'] = [{slotID: 'surviv-io_300x250_webview_2', slotName: '/421469808/surviv.io_300x250_webview_2', sizes: [[300, 250]]}];
		this.requestManager['surviv-io_300x250_webview_2'] = {adserverRequestSent: false, aps: false, prebid: false};

		this.adUnits['surviv-io_728x90_webview'] = [{
		code: 'surviv-io_728x90_webview',
		mediaTypes: {
			banner: {
				sizes: [728, 90]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					publisherId: '156857',
					adSlot: '1699695@728x90'
				}
			}
		]
	}];
	this.adSlots['surviv-io_728x90_webview'] = {adunit: 'surviv.io_728x90_webview', sizes: [728, 90], reload: true};
		this.adUnitsAps['surviv-io_728x90_webview'] = [{slotID: 'surviv-io_728x90_webview', slotName: '/421469808/surviv.io_728x90_webview', sizes: [[728, 90]]}];
		this.requestManager['surviv-io_728x90_webview'] = {adserverRequestSent: false, aps: false, prebid: false};

		this.adUnits['surviv-io_300x600'] = [{
		code: 'surviv-io_300x600',
		mediaTypes: {
			banner: {
				sizes: [300, 600]
			}
		...
		bids: [
			...
			},
			{
				...
				params: {
					publisherId: '156857',
					adSlot: '2082799@300x600'
				}
			}
		]
	}];
	this.adSlots['surviv-io_300x600'] = {adunit: 'surviv.io_300x600', sizes: [300, 600], reload: true};
		this.adUnitsAps['surviv-io_300x600'] = [{slotID: 'surviv-io_300x600', slotName: '/421469808/surviv.io_300x600', sizes: [[300, 600]]}];
		this.requestManager['surviv-io_300x600'] = {adserverRequestSent: false, aps: false, prebid: false};

		
		try {
		//bigger then
		if (window.matchMedia("(min-width: 1500px) and (min-height: 950px)").matches) {
			this.adSlots['surviv-io_728x90']['sizes'] = [[300, 250], [970, 250], [970, 90], [728, 90]];
			this.adUnits['surviv-io_728x90'][0]['mediaTypes']['banner']['sizes'] = [[300, 250], [970, 250], [970, 90], [728, 90]];
			this.adUnits['surviv-io_728x90'][0]['bids'].push({bidder: 'ix',	params: { siteId: '254671', size: [970, 90] }});
			this.adUnits['surviv-io_728x90'][0]['bids'].push({bidder: 'ix',	params: { siteId: '254671', size: [970, 250] }});
			this.adUnits['surviv-io_728x90'][0]['bids'].push({bidder: 'ix',	params: { siteId: '254671', size: [300, 250] }});
			this.adUnitsAps['surviv-io_728x90'][0]['sizes'] = [[300, 250], [970, 250], [970, 90], [728, 90]];
		} else {
			//if true banner can match smaller
			if (window.matchMedia("(min-height: 769px)").matches) {
				//bigger then
				if (window.matchMedia("(min-width: 900px)").matches) {
					this.adSlots['surviv-io_728x90']['sizes'] = [[970, 90], [728, 90]];
					this.adUnits['surviv-io_728x90'][0]['mediaTypes']['banner']['sizes'] = [[970, 90], [728, 90]];
					this.adUnits['surviv-io_728x90'][0]['bids'].push({bidder: 'ix',	params: { siteId: '254671', size: [970, 90] }});
					this.adUnitsAps['surviv-io_728x90'][0]['sizes'] = [[970, 90], [728, 90]];
				}
			} else {
				//bigger then
		...
		//between
		if (window.matchMedia("(min-width: 750px) and (max-width: 830px)").matches) {
			this.adSlots['surviv-io_300x250_2']['sizes'] = [[300, 250], [728, 90]];
			this.adUnits['surviv-io_300x250_2'][0]['mediaTypes']['banner']['sizes'] = [[300, 250], [728, 90]];
			this.adUnits['surviv-io_300x250_2'][0]['bids'].push({bidder: 'ix',	params: { siteId: '254832', size: [728, 90] }});
			this.adUnitsAps['surviv-io_300x250_2'][0]['sizes'] = [[300, 250], [728, 90]];
			
			this.adSlots['surviv-io_300x250_mobile_2']['sizes'] = [[300, 250], [728, 90]];
			this.adUnits['surviv-io_300x250_mobile_2'][0]['mediaTypes']['banner']['sizes'] = [[300, 250], [728, 90]];
			this.adUnits['surviv-io_300x250_mobile_2'][0]['bids'].push({bidder: 'ix',	params: { siteId: '321921', size: [728, 90] }});
			this.adUnitsAps['surviv-io_300x250_mobile_2'][0]['sizes'] = [[300, 250], [728, 90]];
		}

		//bigger then
		if (window.matchMedia("(min-width: 830px)").matches) {
			this.adSlots['surviv-io_300x250_2']['sizes'] = [[300, 250], [970, 90], [728, 90], [970, 250]];
			this.adUnits['surviv-io_300x250_2'][0]['mediaTypes']['banner']['sizes'] = [[300, 250], [970, 90], [728, 90], [970, 250]];
			this.adUnits['surviv-io_300x250_2'][0]['bids'].push({bidder: 'ix',	params: { siteId: '254832', size: [970, 250] }});
			this.adUnits['surviv-io_300x250_2'][0]['bids'].push({bidder: 'ix',	params: { siteId: '254832', size: [970, 90] }});
			this.adUnits['surviv-io_300x250_2'][0]['bids'].push({bidder: 'ix',	params: { siteId: '254832', size: [728, 90] }});
			this.adUnits['surviv-io_300x250_2'][0]['bids'].push({bidder: 'cpmstar',	params: { placementId: '81289' }});
			this.adUnitsAps['surviv-io_300x250_2'][0]['sizes'] = [[300, 250], [970, 90], [728, 90], [970, 250]];
			
			this.adSlots['surviv-io_300x250_mobile_2']['sizes'] = [[300, 250], [970, 90], [728, 90], [970, 250]];
			this.adUnits['surviv-io_300x250_mobile_2'][0]['mediaTypes']['banner']['sizes'] = [[300, 250], [970, 90], [728, 90], [970, 250]];
			this.adUnits['surviv-io_300x250_mobile_2'][0]['bids'].push({bidder: 'ix',	params: { siteId: '321921', size: [970, 250] }});
			this.adUnits['surviv-io_300x250_mobile_2'][0]['bids'].push({bidder: 'ix',	params: { siteId: '321921', size: [970, 90] }});
			this.adUnits['surviv-io_300x250_mobile_2'][0]['bids'].push({bidder: 'ix',	params: { siteId: '321921', size: [728, 90] }});
			this.adUnitsAps['surviv-io_300x250_mobile_2'][0]['sizes'] = [[300, 250], [970, 90], [728, 90], [970, 250]];
		}
		
		//bigger then
		if (window.matchMedia("(min-width: 1366px)").matches) {
			this.adSlots['surviv-io_300x600']['sizes'] = [[120, 600], [160, 600], [300, 250], [300, 600]];
			this.adUnits['surviv-io_300x600'][0]['mediaTypes']['banner']['sizes'] = [[120, 600], [160, 600], [300, 250], [300, 600]];
			this.adUnitsAps['surviv-io_300x600'][0]['sizes'] = [[120, 600], [160, 600], [300, 250], [300, 600]];
		} else {
			this.adSlots['surviv-io_300x600']['sizes'] = [[120, 600], [160, 600]];
			this.adUnits['surviv-io_300x600'][0]['mediaTypes']['banner']['sizes'] = [[120, 600], [160, 600]];
			this.adUnitsAps['surviv-io_300x600'][0]['sizes'] = [[120, 600], [160, 600]];
		}
		
		if(!this.inIframe()) {
			this.adUnits['surviv-io_300x250_2'][0]['mediaTypes']['video'] = {context: 'outstream', playerSize: [300, 250]};
		}
		
		if(!this.inIframe()) {
			if(window.location.hostname == 'surviv.io') {
				this.adUnits['surviv-io_300x250_2'][0]['bids'].push({bidder: 'rubicon',	params: { accountId: '15636', siteId: '251260', zoneId: '1245602' }});
				this.adUnits['surviv-io_300x250'][0]['bids'].push({bidder: 'rubicon',	params: { accountId: '15636', siteId: '251260', zoneId: '1245610' }});
				this.adUnits['surviv-io_728x90'][0]['bids'].push({bidder: 'rubicon',	params: { accountId: '15636', siteId: '251260', zoneId: '1245608' }});
			}
		}
	} catch(e) {}}

aiptag.settings.iAmazonAds&&!function(a,b,c,d,g,e,h){b[a]||(b[a]={init:function(){b[a]._Q.push(["i",arguments])},fetchBids:function(){b[a]._Q.push(["f",arguments])},setDisplayBids:function(){},targetingKeys:function(){return[]},_Q:[]},e=c.createElement(d),e.async=!0,e.src=g,h=c.getElementsByTagName(d)[0],h.parentNode.insertBefore(e,h))}("apstag",window,document,"script","//c.amazon-adsystem.com/aax2/apstag.js");
aipAPI.prototype.detectBlockedAds=function(){(function(){var a=document.createElement("script");a.async=!0;a.onerror=function(){aipAPItag.gptBlocked=!0};a.type="text/javascript";a.src=aipAPItag.protocol+"api.adinplay.com/libs/aiptag/assets/adsbygoogle.js";var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b)})()};
aipAPI.prototype.initGPT=function(){if(aiptag.settings.iDFPAdSlots||aiptag.settings.sRewardedAdUnitVideo)googletag.cmd.push(function(){googletag.pubads().disableInitialLoad()}),aipAPItag.gptLoaded||(function(){var a=document.createElement("script");a.async=!0;a.type="text/javascript";a.src="https://securepubads.g.doubleclick.net/tag/js/gpt.js";var b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(a,b)}(),aipAPItag.gptLoaded=!0)};
aipAPI.prototype.initGDPR=function(){!0===aiptag.gdprShowConsentTool&&window.navigator.cookieEnabled?function(a,b){if("false"===aipAPItag.userFromEEA)aipAPItag.log("userFromEEA cookie value=false, user not from EEA, start showing ads"),aipAPItag.start();else if(a.__cmp)aipAPItag.log("CMP already loaded, start showing ads"),aipAPItag.start();else{var c=function(){var a="none";!0===aiptag.gdprShowConsentToolButton&&(a="block");try{if(!aipAPItag.isInPage(b.getElementById("cmpPersistentLink"))){var c=
b.createElement("div");b.getElementsByTagName("body")[0].appendChild(c);c.id="cmpPersistentLink";c.style.display=a;c.innerHTML='<a onclick="window.__cmp(\'showConsentToolSettings\')" class="cmp-persistent-link" style="cursor: pointer; position: fixed; background-color: #1f83be; padding: 5px 15px; color: #ffffff; display: flex; max-height: 30px; z-index: 999994; bottom: 0px; left: 0px; border-top-left-radius: 3px; border-top-right-radius: 3px;"><svg width="16px" height="17px" viewBox="0 0 16 17" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin-right: 5px; height: 17px;"><g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g id="cog" fill="#FFFFFF" fill-rule="nonzero"><path d="M15.596917,9.98326938 L14.5041079,9.33798816 C14.5728064,8.7815386 14.5728064,8.2184614 14.5041079,7.66201184 L15.596917,7.01673062 C15.9178229,6.82726259 16.0726124,6.43742732 15.9670848,6.0741546 C15.5912871,4.78033611 14.9223646,3.61573153 14.0390021,2.66061113 C13.7831755,2.38401797 13.3749053,2.32348965 13.0525249,2.51384881 L11.9613243,3.15813608 C11.5248519,2.81840117 11.0481221,2.53648663 10.542482,2.31910255 L10.542482,1.02991108 C10.542482,0.648438733 10.2860522,0.316869683 9.92305592,0.229024792 C8.66155,-0.07632446 7.33871809,-0.0763587342 6.07694408,0.229024792 C5.71398131,0.316869683 5.457518,0.648404458 5.457518,1.02991108 L5.457518,2.31910255 C4.95187406,2.53647872 4.47514334,2.81839382 4.03867572,3.15813608 L2.94747511,2.51384881 C2.62506122,2.32348965 2.21679094,2.38401797 1.96099786,2.66061113 C1.07763542,3.61573153 0.40871289,4.78037038 0.0329152236,6.0741546 C-0.072612407,6.43742732 0.0821770899,6.82722832 0.403082962,7.01673062 L1.49589212,7.66201184 C1.42719356,8.2184614 1.42719356,8.7815386 1.49589212,9.33798816 L0.403082962,9.98326938 C0.0821770899,10.1727374 -0.072612407,10.5625727 0.0329152236,10.9258454 C0.40871289,12.2196296 1.07763542,13.3842685 1.96099786,14.3393889 C2.21682445,14.615982 2.62509474,14.6765103 2.94747511,14.4861855 L4.03867572,13.8418982 C4.47514096,14.1816349 4.95187243,14.4635389 5.457518,14.6808975 L5.457518,15.9700889 C5.457518,16.3515613 5.7139478,16.6831303 6.07694408,16.7709752 C7.33848351,17.0763245 8.66128191,17.0763587 9.92305592,16.7709752 C10.2860187,16.6831303 10.542482,16.3515955 10.542482,15.9700889 L10.542482,14.6808975 C11.0481183,14.4635198 11.5248475,14.1816171 11.9613243,13.8418982 L13.0525249,14.4861855 C13.3749053,14.6765446 13.7831755,14.6160163 14.0390021,14.3393889 C14.9223646,13.3842685 15.5912871,12.2196296 15.9670848,10.9258454 C16.0726124,10.5625727 15.9178229,10.1727717 15.596917,9.98326938 Z M13.4026193,13.4264943 L11.8507364,12.510001 C10.9463288,13.3007421 10.6255905,13.4997041 9.47011484,13.9172673 L9.47011484,15.7502196 C8.50024808,15.9548373 7.49975192,15.9548373 6.52988516,15.7502196 L6.52988516,13.9172673 C5.4031959,13.5101235 5.07699522,13.3210668 4.14926358,12.510001 L2.59738075,13.4264943 C1.9368696,12.6693763 1.43490124,11.7817076 1.12525522,10.8230912 L2.67780828,9.90659789 C2.4588108,8.69270694 2.45871027,8.30790999 2.67780828,7.09340211 L1.12525522,6.17690879 C1.43490124,5.21829242 1.93690311,4.33058946 2.59738075,3.57312864 L4.14926358,4.49030745 C5.0667072,3.68712478 5.39129933,3.4941265 6.52988516,3.08269846 L6.52988516,1.24978037 C7.49971774,1.04482059 8.50028226,1.04482059 9.47011484,1.24978037 L9.47011484,3.08273274 C10.6087677,3.49419505 10.9333933,3.6872276 11.8507364,4.49034172 L13.4026193,3.57316291 C14.0630969,4.33058946 14.5650988,5.21829242 14.8747448,6.17694306 L13.3221917,7.09343638 C13.5412227,8.3076358 13.5412897,8.69212428 13.3221917,9.90663217 L14.8747448,10.8231255 C14.5650988,11.7817076 14.0631304,12.6694105 13.4026193,13.4264943 Z M8,5.20968958 C6.22607014,5.20968958 4.78289853,6.68570996 4.78289853,8.50001714 C4.78289853,10.3143243 6.22607014,11.7903447 8,11.7903447 C9.77392986,11.7903447 11.2171015,10.3143243 11.2171015,8.50001714 C11.2171015,6.68570996 9.77392986,5.20968958 8,5.20968958 Z M8,10.6935688 C6.81738009,10.6935688 5.85526568,9.70955526 5.85526568,8.50001714 C5.85526568,7.29047902 6.81738009,6.30646543 8,6.30646543 C9.18261991,6.30646543 10.1447343,7.29047902 10.1447343,8.50001714 C10.1447343,9.70955526 9.18261991,10.6935688 8,10.6935688 Z" id="Shape"></path></g></g></svg>Privacy settings</a>'}}catch(v){}},
d=function(){a.__cmp("getVendorConsents",[aipAPItag.gdpr.googleId],function(a){a=a.vendorConsents[aipAPItag.gdpr.googleId];aipAPItag.gdpr.googleConsent=a;aipAPItag.log("Google consent: "+a);"undefined"===typeof a||!1===a?googletag.cmd.push(function(){aipAPItag.log("Setting DFP to deliver non targeted ads...");googletag.pubads().setRequestNonPersonalizedAds(1)}):googletag.cmd.push(function(){aipAPItag.log("Setting DFP to deliver targeted ads...");googletag.pubads().setRequestNonPersonalizedAds(0)})})},
g=function(){var a=("; "+b.cookie).split("; euconsent=");a=2===a.length?a.pop().split(";").shift():void 0;return"undefined"===typeof a?!1:!0},e=function(c,d,g,e,q){"undefined"===typeof q&&(q="/");"undefined"===typeof e?(e=(a&&a.location&&a.location.hostname||"").split("."),e=";domain="+(1<e.length?e.slice(-2).join("."):"")):e="";var h=new Date;h.setSeconds(h.getSeconds()+g);b.cookie=c+" = "+d+e+";path="+q+";max-age="+g+";Expires="+h.toUTCString()},h=function(){aiptag.gdprVendors={id:aipAPItag.gdpr.googleId,
name:"Google LLC",policyUrl:"https://policies.google.com/technologies/ads",purposeIds:[1,2,3,4,5],legIntPurposeIds:[],featureIds:[1,2,3]};a.__cmp=function(){function c(){if(!a.frames.__cmpLocator)if(b.body){var d=b.createElement("iframe");d.style.display="none";d.name="__cmpLocator";b.body.appendChild(d)}else setTimeout(c,5)}(a.attachEvent||a.addEventListener)("message",function(b){a.__cmp.receiveMessage(b)},!1);c();var d=[],e=function(b,c,e){"ping"===b?e&&e({gdprAppliesGlobally:!!(a.__cmp&&a.__cmp.config&&
a.__cmp.config.gdprAppliesGlobally),cmpLoaded:!1}):d.push({command:b,parameter:c,callback:e})};e.commandQueue=d;e.receiveMessage=function(a){var b=a&&a.data&&a.data.__cmpCall;b&&d.push({callId:b.callId,command:b.command,parameter:b.parameter,event:a})};e.config={gdprAppliesGlobally:!1,storeConsentGlobally:!1,forceLocale:"en-us"};return e}();a.__cmp("addEventListener","onSubmit",function(a){d();c();aipAPItag.start()});a.__cmp("addEventListener","cmpReady",function(e){try{clearTimeout(aipAPItag.GDPRloadTimeout)}catch(q){}if("bottom"===
aiptag.gdprConsentToolPosition)try{b.getElementById("aip_gdpr_banner").style.top="auto",b.getElementById("aip_gdpr_message").style.maxWidth="none",b.getElementById("aip_gdpr_message").style.paddingTop="0",b.getElementById("aip_gdpr_message").style.paddingBottom="0",b.getElementById("aip_gdpr_title").style.fontSize="19px",b.getElementById("aip_gdpr_title").style.padding="0",b.getElementById("aip_gdpr_continue").style.height="40px",b.getElementById("aip_gdpr_continue").style.lineHeight="40px",b.getElementById("aip_gdpr_learnmore").style.height=
"25px",b.getElementById("aip_gdpr_learnmore").style.lineHeight="25px",b.getElementById("aip_gdpr_banner").style.boxShadow="0 0 5px #1f83be",b.getElementById("aip_gdpr_banner").style.backgroundColor="#ffffff",b.getElementById("aip_gdpr_banner").style.fontSize="medium",b.getElementById("aip_gdpr_banner").style.lineHeight="normal",b.getElementById("aip_gdpr_title").style.textAlign="left",b.getElementById("aip_gdpr_consent").style.maxWidth="100%",b.getElementById("aip_gdpr_content").style.maxWidth="890px"}catch(q){}if(g()){var h;
a.__cmp("getVendorList",null,function(a){h=a.vendorListVersion});var l;a.__cmp("getVendorConsents",null,function(a){l=a.vendorListVersion});aipAPItag.log("globalVendorListVersion: "+h);aipAPItag.log("consentsVendorListVersion: "+l);h!==l&&aipAPItag.log("Global vendor list version does not match consents cookie vendor list version. Starting CMP.");d();c();aipAPItag.start()}else a.__cmp("showConsentTool"),"bottom"===aiptag.gdprConsentToolPosition&&(aipAPItag.log("CMP tool used but ads loaded with no consent, start showing ads"),
aipAPItag.gdpr.googleConsent=!1,aipAPItag.start())});var e=b.createElement("script");e.async=!0;e.src=aipAPItag.protocol+"api.adinplay.com/libs/gdpr/cmp/cmp.bundle.js";b.getElementsByTagName("head")[0].appendChild(e)};aipAPItag.GDPRloadTimeout=setTimeout(function(){aipAPItag.log("GDPR timeout occured, assuming user from EEA, start showing ads");aipAPItag.gdpr.googleConsent=!1;aipAPItag.start()},3E3);if(g())h();else if("true"===aipAPItag.userFromEEA)aipAPItag.log("userFromEEA cookie value=true, user from EEA, GDPR Consent required"),
h();else{var l=new XMLHttpRequest;l.onreadystatechange=function(){if(l.readyState==XMLHttpRequest.DONE)if(200==l.status){var a=l.responseText.toUpperCase();0<="CH IS LI NO AT BE BG CY CZ DE DK EE ES FI FR GR HR HU IE IT LT LU LV MT NL PL PT RO SE SI SK GB".split(" ").indexOf(a)?(e("userFromEEA","true","7889229"),aipAPItag.log("GDPR Consent required for "+a),h()):(e("userFromEEA","false","7889229"),aipAPItag.log("GDPR Consent not required for "+a),aipAPItag.start())}else aipAPItag.log("Unknown geo-targeting issue, assuming user from EEA"),
h()};l.ontimeout=function(a){aipAPItag.log("Geo-targeting timeout occured, assuming user from EEA");h()};l.open("GET",aipAPItag.protocol+"geo.adinplay.com/geoip/country.php",!0);l.timeout=1500;l.send()}}}(window,document):(aipAPItag.log("CMP tool not used, start showing ads"),aipAPItag.start())};aipAPI.prototype.initDisplayTag=function(){aiptag.cmd.display.push=function(a){Array.prototype.push.apply(this,arguments);aipAPItag.executeDisplayCmd()};aipAPItag.executeDisplayCmd()};
aipAPI.prototype.executeDisplayCmd=function(){for(k=0;k<aiptag.cmd.display.length;k++)aiptag.cmd.display[k]();aiptag.cmd.display.length=0};aipAPI.prototype.initPlayerTag=function(){aiptag.cmd.player.push=function(a){Array.prototype.push.apply(this,arguments);aipAPItag.executePlayerCmd()};aipAPItag.executePlayerCmd()};aipAPI.prototype.executePlayerCmd=function(){for(k=0;k<aiptag.cmd.player.length;k++)aiptag.cmd.player[k]();aiptag.cmd.player.length=0};aipAPI.prototype.showConsentToolSettings=function(){try{window.__cmp("showConsentToolSettings")}catch(a){}};
aipAPI.prototype.showConsentToolButton=function(){try{document.getElementById("cmpPersistentLink").style.display="block"}catch(a){}};aipAPI.prototype.hideConsentToolButton=function(){try{document.getElementById("cmpPersistentLink").style.display="none"}catch(a){}};aipAPI.prototype.isHidden=function(a){a=document.getElementById(a);var b=!1;try{null===a&&(b=!0),b=null===a.offsetParent}catch(c){}return b};
aipAPI.prototype.validateQueryParams=function(a,b){return-1!==window.location.href.indexOf(a+"="+b)?!0:!1};aipAPI.prototype.urlParamUpdate=function(a,b,c,d){var g=new RegExp("[\\?&]"+b+"=([^&#]*)","i"),e=g.exec(a);if(null===e)d=/\?/.test(a),a=a+(d?"&":"?")+b+"="+c;else{var h=e[0].charAt(0);a=!0===d?a.replace(g,h+b+"="+e[1]+"%26"+c):a.replace(g,h+b+"="+c)}return a};
aipAPI.prototype.restoreLog=function(){try{if(!("console"in window&&"firebug"in console)){console.log=null;console.log;delete console.log;var a=document.createElement("iframe");a.style.display="none";document.body.appendChild(a);window.console=a.contentWindow.console}}catch(b){}};
aipAPI.prototype.log=function(a,b){if(this.debug){aipAPItag.restoreLog();try{if("string"==typeof a){var c=(new Date).toLocaleTimeString();c+=":"+(new Date).getMilliseconds();window.console.log.apply(console,["%cAdinPlay","display: inline-block; color: #fff; background: #DD0420; padding: 1px 4px; border-radius: 3px;",c,a])}else console.log(a);b&&console.log(b)}catch(d){}}};
aipAPI.prototype.getScript=function(a,b){var c=document.head||document.getElementsByTagName("head")[0],d=document.createElement("script"),g=!0;d.async="async";d.type="text/javascript";d.charset="UTF-8";d.src=a;d.onerror=d.onload=d.onreadystatechange=function(){!g||d.readyState&&!/loaded|complete/.test(d.readyState)||(g=!1,b(),d.onerror=d.onload=d.onreadystatechange=null)};c.appendChild(d)};
aipAPI.prototype.sdkLoaded=function(){return"undefined"!=typeof google&&google&&"undefined"!=typeof google.ima&&google.ima?!0:!1};aipAPI.prototype.isInPage=function(a){try{return a===document.body?!1:document.body.contains(a)}catch(b){return!1}};aipAPI.prototype.isMobile=function(){try{if(/Mobi|Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))return!0}catch(a){}return!1};
aipAPI.prototype.wait=function(a,b,c,d,g){var e=0,h=function(){e+=a;c()?d():e>=b?g():setTimeout(h,a)};h()};aipAPI.prototype.inIframe=function(){try{return window.self!==window.top}catch(a){return!0}};aipAPI.prototype.forceRedraw=function(a){if(a){var b=document.createTextNode(" "),c=a.style.display;a.appendChild(b);a.style.display="none";setTimeout(function(){a.style.display=c;b.parentNode.removeChild(b)},20);aipAPItag.log("forceRedraw")}};
aipAPI.prototype.inArray=function(a,b){for(var c=0,d=0,g=b.length;d<g;d++){if(b[d]==a)return d;c++}return-1};aipAPI.prototype.sendEvent=function(a){this.log(a);aipSendEvent(a)};var aipSendEvent=function(a){};aipAPI.prototype.setCurrency=function(){aip_pbjs.que.push(function(){aip_pbjs.setConfig({currency:{adServerCurrency:"EUR",granularityMultiplier:1,bidderCurrencyDefault:{openx:"EUR"}}})})};
aipAPI.prototype.getAllWinningBids=function(){(function(){var a=aip_pbjs.getBidResponses(),b=aip_pbjs.getAllWinningBids(),c=[];Object.keys(a).forEach(function(d){a[d].bids.forEach(function(a){c.push({bid:a,adunit:d,adId:a.adId,bidder:a.bidder,time:a.timeToRespond,cpm:a.cpm,msg:a.statusMessage,rendered:!!b.find(function(b){return b.adId==a.adId})})})});if(c.length)if(console.table)console.table(c);else for(var d=0;d<c.length;d++)console.log(c[d]);else console.warn("NO prebid responses")})()};
...
aipAPI.prototype.start=function(){try{clearTimeout(aipAPItag.GDPRloadTimeout)}catch(b){}if(!0!==aipAPItag.started){aipAPItag.started=!0;aiptag.settings.iDFPAdSlots&&(aipDisplayTag=new aipDisplay,aipDisplayTag.displayInit(),aipAPItag.initDisplayTag());if(aiptag.settings.sAdUnitVideo||aiptag.settings.sRewardedAdUnitVideo)aiptag.settings.sRewardedAdUnitVideo&&!aiptag.settings.sAdUnitVideo?aipAPItag.initPlayerTag():aipAPItag.sdkLoaded()?aipAPItag.initPlayerTag():aipAPItag.getScript("//imasdk.googleapis.com/js/sdkloader/ima3.js",
function(){aipAPItag.initPlayerTag();aipAPItag.sdkLoaded()||(aipAPItag.sdkBlocked=!0)});try{if("function"===typeof aipGDPRCallback_OnAccept){var a=!0;!1===aipAPItag.getConsent()&&(a=!1);aipGDPRCallback_OnAccept(a)}}catch(b){}}};
aipAPI.prototype.getConsent=function(){if("false"===aipAPItag.userFromEEA)return aipAPItag.log("Consent not needed user not from: EEA"),!0;if(!1===aipAPItag.gdpr.googleConsent)return aipAPItag.log("Consent: not given: aipAPItag.gdpr.googleConsent=false"),!1;if(!0!==aiptag.gdprShowConsentTool&&!1===aiptag.gdprConsent)return aipAPItag.log("Consent: not given: aiptag.gdprShowConsentTool !== true & aiptag.gdprConsent = false"),!1;aipAPItag.log("Consent: given");return!0};
function aipDisplay(){aiptag.settings.iAutoRefreshBanners&&aiptag.settings.iAutoRefreshBannersViewPercentage&&aiptag.settings.iAutoRefreshBannersTimeout&&googletag.cmd.push(function(){googletag.pubads().addEventListener("slotVisibilityChanged",function(a){var b=a.slot.getSlotElementId();aipAPItag.adUnitsPercentage[b]=a.inViewPercentage;1==aipAPItag.adUnitsRefreshFlag[b]&&(aipAPItag.adUnitsRefreshFlag[b]=!1,aipDisplayTag.display(b))})})}
aipDisplay.prototype.displayInit=function(){if(aiptag.settings.iAmazonAds&&(apstag.init({pubID:"53b902f9-cf9c-4605-aec3-2c8ce65042b8",adServer:"googletag",bidTimeout:aipAPItag.timeout_bid_display}),aipAPItag.debug))try{apstag.debug("enableConsole")}catch(a){}aiptag.settings.iPrebidAnalyticsByRoxot&&aip_pbjs.que.push(function(){aip_pbjs.enableAnalytics({provider:"roxot",options:{publisherIds:["511f1c27-5069-466f-b2f8-d21b9da3b540"]}})})};
aipDisplay.prototype.displaySetup=function(a){aip_pbjs.que.push(function(){aipAPItag.displayBidCpm.rhythmone=.9;aipAPItag.displayBidCpm.rubicon=.62;aipAPItag.displayBidCpm.GumGum=.95;if(aiptag.settings.sCustomDisplayBidCpmAdjustment){var b=aiptag.settings.sCustomDisplayBidCpmAdjustment;for(key in b)b[key][a]&&(aipAPItag.log("Custom Bid adjust "+key+" for: "+a+" with value: "+b[key][a]),aipAPItag.displayBidCpm[key]=b[key][a])}aip_pbjs.bidderSettings={rhythmone:{bidCpmAdjustment:function(a,b){aipAPItag.log("Bid adjust for: "+
b.bidderCode);return a*aipAPItag.displayBidCpm.rhythmone}},rubicon:{bidCpmAdjustment:function(a,b){aipAPItag.log("Bid adjust for: "+b.bidderCode);return a*aipAPItag.displayBidCpm.rubicon}}};aipAPItag.debug&&aip_pbjs.setConfig({debug:!0});aip_pbjs.setConfig({userSync:{iframeEnabled:!0,useBidCache:!0,syncsPerBidder:99999,filterSettings:{iframe:{bidders:"*",filter:"include"}},syncDelay:6E3},bidderTimeout:aipAPItag.timeout_bid_display,enableSendAllBids:!0,bidderSequence:"random",priceGranularity:{buckets:[{precision:2,
min:0,max:.5,increment:.01},{precision:2,min:.5,max:5,increment:.05},{precision:2,min:5,max:10,increment:.1},{precision:2,min:10,max:20,increment:.5},{precision:2,min:20,max:30,increment:1},{precision:2,min:30,max:50,increment:5}]},publisherDomain:aipAPItag.protocol+"api.adinplay.com"});aip_pbjs.setConfig({schain:{validation:"relaxed",config:{ver:"1.0",complete:1,nodes:[{asi:"adinplay.com",sid:aiptag.settings.sPubName,hp:1}]}}})})};
aipDisplay.prototype.clear=function(a){googletag.cmd.push(function(){googletag.pubads().clear([aipAPItag.adSlot[a]]);aipAPItag.log("AD SLOT CLEARED: "+a)})};aipDisplay.prototype.destroy=function(a){aiptag.settings.iDisableDestroyFunction||googletag.cmd.push(function(){googletag.destroySlots([aipAPItag.adSlot[a]]);aipAPItag.adUnitsLoaded[a]=null;aipAPItag.log("AD SLOT DESTROYED: "+a)})};aipDisplay.prototype.setReload=function(a){aipAPItag.adSlots[a].reload=!0};
aipDisplay.prototype.unsetReload=function(a){aipAPItag.adSlots[a].reload=!1};aipDisplay.prototype.getReload=function(a){return aipAPItag.adSlots[a].reload};aipDisplay.prototype.display=function(a){aipAPItag.log("AD SLOT DISPLAY: "+a);aipDisplayTag.refresh(a)};
aiptag.settings.iAutoRefreshBanners&&aiptag.settings.iAutoRefreshBannersViewPercentage&&aiptag.settings.iAutoRefreshBannersTimeout&&(aipDisplay.prototype.autoRefresh=function(a){aipAPItag.adUnitsPercentage[a]>=aiptag.settings.iAutoRefreshBannersViewPercentage?aipDisplayTag.display(a):aipAPItag.adUnitsRefreshFlag[a]=!0});aipDisplay.prototype.refresh=function(a){aipAPItag.log("AD SLOT REFRESH: "+a);aiptag.cmd.queue.push(aipDisplayTag.wrapFunction(aipDisplayTag.refreshTag,this,[a]));aipDisplayTag.nextQueue()};
aipDisplay.prototype.refreshTag=function(a){aipAPItag.queue_ready_display=!0;if(aipDisplayTag.getReload(a))if(aipAPItag.adUnitsRefreshed[a]||(aipAPItag.adUnitsRefreshed[a]=0),aipAPItag.adUnitsRefreshed[a]++,aiptag.settings.iDisableEvenAddRefresh&&0==aipAPItag.adUnitsRefreshed[a]%2)aipAPItag.log("AD REFRESH EVEN for: "+a);else{try{aipAPItag.log("aiptag.gdprConsent: "+aiptag.gdprConsent)}catch(c){}!1===aipAPItag.getConsent()?googletag.cmd.push(function(){aipAPItag.log("Setting DFP to deliver non targeted ads...");
googletag.pubads().setRequestNonPersonalizedAds(1)}):googletag.cmd.push(function(){aipAPItag.log("Setting DFP to deliver targeted ads...");googletag.pubads().setRequestNonPersonalizedAds(0)});googletag.cmd.push(function(){googletag.pubads().setTagForChildDirectedTreatment(0)});aiptag.settings.iChildSafeAds&&googletag.cmd.push(function(){googletag.pubads().setTagForChildDirectedTreatment(1);aipAPItag.log("COPPA: "+a+" ad request marked with a child-directed status")});if(aipAPItag.inIframe()){aipAPItag.log("iframe display AD");
googletag.cmd.push(function(){googletag.pubads().setTargeting("GS","Yes")});try{aipAPItag.adUnits[a][0].bids.forEach(function(a,b,g){"gumgum"===a.bidder&&g.splice(b,1)})}catch(c){}}else aipAPItag.log("none iframe display Ad"),googletag.cmd.push(function(){googletag.pubads().setTargeting("GS","No")});aiptag.subid&&(aipAPItag.log("Custom SubID"),googletag.cmd.push(function(){googletag.pubads().setTargeting("subid",aiptag.subid)}));googletag.cmd.push(function(){try{var b=aipAPItag.adUnitsRefreshed[a].toString();
googletag.pubads().setTargeting("FC",b);aipAPItag.log(a+", FC="+b)}catch(d){}});var b="Other";try{/(cros)/.test(window.navigator.userAgent.toLowerCase())&&(b="ChromeOS")}catch(c){}googletag.cmd.push(function(){googletag.pubads().setTargeting("OS",b);aipAPItag.log("OS="+b)});aipAPItag.log("AD SLOT REFRESHTAG: "+a+" - "+aipAPItag.adUnitsRefreshed[a]);aipAPItag.queue_ready_display=!1;aip_pbjs.que.push(function(){aipAPItag.adUnitsLoaded[a]||(aipAPItag.adUnitsLoaded[a]="loaded",googletag.cmd.push(function(){aipAPItag.adSlot[a]=
googletag.defineSlot("/"+aiptag.settings.sNetworkIdDisplay+"/"+aipAPItag.adSlots[a].adunit,aipAPItag.adSlots[a].sizes,a).addService(googletag.pubads());googletag.enableServices();googletag.display(a);aipAPItag.log("AD SLOT DEFINED: "+a)}));aipDisplayTag.unsetReload(a);setTimeout(aipDisplayTag.setReload.bind(null,a),aipAPItag.timeout_reload_display);aipDisplayTag.displaySetup(a);var b=aipAPItag.timeout_bid_display;aipAPItag.log("AD REQUEST: "+a);aipAPItag.requestManager[a].adserverRequestSent=!1;aipAPItag.requestManager[a].prebid=
!1;aipAPItag.requestManager[a].aps=!1;window.setTimeout(function(){aipDisplayTag.sendAdserverRequest(a)},b);aip_pbjs.requestBids({timeout:b,adUnits:aipAPItag.adUnits[a],adUnitCodes:[a],bidsBackHandler:function(b){try{aipAPItag.log("Targeting params:"),aipAPItag.log(JSON.stringify(aip_pbjs.getAdserverTargeting())),aipAPItag.log("All bid objects:"),aipAPItag.log(JSON.stringify(aip_pbjs.getBidResponses()))}catch(g){}googletag.cmd.push(function(){aiptag.settings.iShowAdblockAdsDisplay&&aipAPItag.gptBlocked?
(aipDisplayTag.blocked(a),aipAPItag.queue_ready_display=!0,aipDisplayTag.nextQueue()):(aip_pbjs.setTargetingForGPTAsync([a]),aipAPItag.requestManager[a].prebid=!0,aipDisplayTag.biddersBack(a),console.log("prebid biddersBack - "+a))})}});aiptag.settings.iAmazonAds&&apstag.fetchBids({slots:aipAPItag.adUnitsAps[a],timeout:b},function(b){googletag.cmd.push(function(){apstag.setDisplayBids();aipAPItag.requestManager[a].aps=!0;console.log("aps biddersBack - "+a);aipDisplayTag.biddersBack(a)})})})}else aipAPItag.log("AD REFRESH called to soon for: "+
a),aipDisplayTag.nextQueue()};aipDisplay.prototype.biddersBack=function(a){aiptag.settings.iAmazonAds?aipAPItag.requestManager[a].aps&&aipAPItag.requestManager[a].prebid&&aipDisplayTag.sendAdserverRequest(a):aipAPItag.requestManager[a].prebid&&aipDisplayTag.sendAdserverRequest(a)};
aipDisplay.prototype.sendAdserverRequest=function(a){!0!==aipAPItag.requestManager[a].adserverRequestSent&&(aipAPItag.requestManager[a].adserverRequestSent=!0,googletag.cmd.push(function(){googletag.pubads().refresh([aipAPItag.adSlot[a]])}),aipAPItag.log("AD LOAD: "+a),aipAPItag.queue_ready_display=!0,aipDisplayTag.nextQueue(),aiptag.settings.iAutoRefreshBanners&&aiptag.settings.iAutoRefreshBannersViewPercentage&&aiptag.settings.iAutoRefreshBannersTimeout&&setTimeout(function(){aipAPItag.adUnitsRefreshFlag[a]=
!1;aipDisplayTag.autoRefresh(a)},aiptag.settings.iAutoRefreshBannersTimeout))};
aipDisplay.prototype.blocked=function(a){if(aiptag.settings.iShowAdblockAdsDisplay)try{var b=[],c="";b["300x250"]=[["300250.jpg",""],["300250.jpg",""]];aipAPItag.adSlot[a].getSizes().forEach(function(d){fallbackSize=d.getWidth()+"x"+d.getHeight();b[fallbackSize]&&(index=Math.floor(Math.random()*b[fallbackSize].length),source=aipAPItag.adSlot[a].getAdUnitPath().replace("/"+aiptag.settings.sNetworkIdDisplay+"/",""),c="<a style='display: inline-block;' target='_blank' href='"+b[fallbackSize][index][1]+
source+"'><div style='width:"+d.getWidth()+"px;height:"+d.getHeight()+'px; background-image: url("//api.adinplay.com/libs/aiptag/fallback/'+b[fallbackSize][index][0]+"\")'></div></a>")});c&&(document.getElementById(a).innerHTML=c,aipAPItag.log("AD BLOCKED: "+a))}catch(d){}};aipDisplay.prototype.wrapFunction=function(a,b,c){return function(){a.apply(b,c)}};aipDisplay.prototype.nextQueue=function(){1==aipAPItag.queue_ready_display&&0<aiptag.cmd.queue.length&&(aipAPItag.log("AD SLOT NEXT QUEUE"),aiptag.cmd.queue.shift()())};
function aipPlayer(a){this.aipConfig={VERSION:aiptag.settings.sVersion,AD_WIDTH:960,AD_HEIGHT:540,LOADING_TEXT:"loading advertisement",PREROLL_ELEM:function(){return document.getElementById("preroll")},PREROLL_ELEM_ID:!1,PREROLL_CONTAINER:!1,AD_FULLSCREEN:!1,AD_CENTERPLAYER:!1,AD_FADING:aiptag.settings.iAdFading,DESCRIPTION_URL:aipAPItag.protocol+aiptag.settings.sPubUrl+"/"};a&&this.configure(a);try{var b=document.createElement("style");this.aipConfig.PREROLL_ELEM_ID="function"===typeof this.aipConfig.PREROLL_ELEM?
this.aipConfig.PREROLL_ELEM().id:this.aipConfig.PREROLL_ELEM.id;b.type="text/css";b.innerHTML="#"+this.aipConfig.PREROLL_ELEM_ID+" video {left: 0;top: 0;}";document.getElementsByTagName("head")[0].appendChild(b)}catch(c){}}aipPlayer.prototype.configure=function(a){var b;for(b in a){var c=a[b];void 0!==c&&a.hasOwnProperty(b)&&(this.aipConfig[b]=c)}return this};
aipPlayer.prototype.getBidPrerollTag=function(a){aip_pbjs.que.push(function(){aipAPItag.debug&&aip_pbjs.setConfig({debug:!0});aip_pbjs.setConfig({userSync:{iframeEnabled:!0,useBidCache:!0,syncsPerBidder:99999,filterSettings:{iframe:{bidders:"*",filter:"include"}},syncDelay:6E3},cache:{url:"https://prebid.adnxs.com/pbc/v1/cache"},bidderTimeout:aipAPItag.timeout_bid_player,enableSendAllBids:!1,bidderSequence:"random",priceGranularity:{buckets:[{precision:2,min:0,max:.1,increment:.01},{precision:2,min:.1,
max:10,increment:.05},{precision:2,min:10,max:15,increment:.25},{precision:2,min:15,max:30,increment:.5},{precision:2,min:30,max:40,increment:1},{precision:2,min:40,max:75,increment:5}]},publisherDomain:aipAPItag.protocol+"api.adinplay.com"});aip_pbjs.setConfig({schain:{validation:"relaxed",config:{ver:"1.0",complete:1,nodes:[{asi:"adinplay.com",sid:aiptag.settings.sPubName,hp:1}]}}});aip_pbjs.requestBids({timeout:aipAPItag.timeout_bid_player,adUnits:[aipAPItag.videoAdUnit[a.aipConfig.AD_UNIT_PREROLL]],
adUnitCodes:["prerollUnit"],bidsBackHandler:function(b){b=aip_pbjs.adServers.dfp.buildVideoUrl({adUnit:aipAPItag.videoAdUnit[a.aipConfig.AD_UNIT_PREROLL],params:{iu:"/"+aiptag.settings.sNetworkIdVideo+"/"+a.aipConfig.AD_UNIT_PREROLL,output:"vast",max_ad_duration:"30000"}});aip_pbjs.markWinningBidAsUsed({adUnitCode:aipAPItag.videoAdUnit[a.aipConfig.AD_UNIT_PREROLL].code});aipAPItag.log(b);a.aipConfig.AD_TAG=b;a.preparePreRoll()}})})};
aipPlayer.prototype.preparePreRoll=function(){var a={};try{aipAPItag.log("aiptag.gdprConsent: "+aiptag.gdprConsent)}catch(c){}!1===aipAPItag.getConsent()&&(a.npa="1",aipAPItag.log("Preroll consent set to: false"));aipAPItag.inIframe()?(a.GS="Yes",aipAPItag.log("iframe preroll AD")):a.GS="No";aiptag.subid&&(a.subid=aiptag.subid,aipAPItag.log("Custom SubID"));a.FC=aiptag.prerollCount;a.tfcd="0";aiptag.settings.iChildSafeAds&&(a.tfcd="1",aipAPItag.log("COPPA: video ad request marked with a child-directed status"));
var b=Object.keys(a).map(function(b){return b+"%3D"+a[b]}).join("%26");if(b)try{this.aipConfig.AD_TAG=aipAPItag.urlParamUpdate(this.aipConfig.AD_TAG,"cust_params",b,!0)}catch(c){}this.prepareAd()};
aipPlayer.prototype.startRewardedAd=function(){var a=this;this.showLoading(!0,!0);aipAPItag.completedTimeoutRewarded=setTimeout(function(){this.aipRewardComplete("timeout",!0)}.bind(this),3E3);googletag.cmd.push(function(){aipAPItag.aipAPIrewardedSlot||(googletag.pubads().addEventListener("rewardedSlotReady",function(a){a.makeRewardedVisible();aipAPItag.log("Rewarded AD: Slot Ready");clearTimeout(aipAPItag.completedTimeoutRewarded);this.showLoading(!1)}.bind(a)),googletag.pubads().addEventListener("rewardedSlotGranted",
function(a){this.aipRewardComplete("granted",!1);aipAPItag.log("Rewarded AD: Granted")}.bind(a)),googletag.pubads().addEventListener("rewardedSlotCanceled",function(a){this.aipRewardComplete("canceled",!1);aipAPItag.log("Rewarded AD: Canceled")}.bind(a)),googletag.pubads().addEventListener("slotRenderEnded",function(a){a.slot.getSlotId().getName()==aipAPItag.aipAPIrewardedSlotId&&(aipAPItag.log("Rewarded AD: slotRenderEnded"),console.log(a));a.slot.getSlotId().getName()==aipAPItag.aipAPIrewardedSlotId&&
a.isEmpty&&(aipAPItag.log("Rewarded AD: Empty"),this.aipRewardComplete("empty",!0))}.bind(a)),googletag.pubads().addEventListener("rewardedSlotFailedToLoad",function(a){aipAPItag.log("Rewarded AD: Failed to load!");this.aipRewardComplete("failed",!0)}.bind(a)),googletag.pubads().addEventListener("rewardedSlotClosed",function(a){this.aipRewardComplete("closed",!1);aipAPItag.log("Rewarded AD: Closed")}.bind(a)),googletag.pubads().addEventListener("rewardedSlotCompleted",function(a){this.aipRewardComplete("completed",
!1);aipAPItag.log("Rewarded AD: Completed!")}.bind(a)));aipAPItag.aipAPIrewardedSlot=googletag.defineOutOfPageSlot(aipAPItag.aipAPIrewardedSlotId,googletag.enums.OutOfPageFormat.REWARDED).addService(googletag.pubads());googletag.enableServices();googletag.display(aipAPItag.aipAPIrewardedSlot);googletag.pubads().refresh([aipAPItag.aipAPIrewardedSlot]);aipAPItag.log("Rewarded AD: Start")})};
...
aiptag.settings.sNetworkIdVideo+"/"+this.aipConfig.AD_UNIT_PREROLL+"&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&max_ad_duration=30000&url="+b+"&description_url="+c+"&correlator="+a;aipAPItag.log(this.aipConfig.AD_TAG);aiptag.prerollCount=aiptag.prerollCount+1||1;aiptag.settings.iVideoAdUnitBidders?aipAPItag.inIframe()?(aipAPItag.log("iframe AD - Normal Ad"),this.preparePreRoll()):(aipAPItag.log("none iframe - Bid Ad"),this.getBidPrerollTag(this)):(aipAPItag.log("No Bid placementID - Normal Ad"),
this.preparePreRoll())}};
...
this.aipConfig.AD_CENTERPLAYER&&(this.aipConfig.AD_CENTERPLAYER=!1,console.log("***WARNING*** AD_FULLSCREEN and AD_CENTERPLAYER cannot both be set to true, setting AD_CENTERPLAYER to false"));if(this.aipConfig.AD_FULLSCREEN)this.aipConfig.PREROLL_CONTAINER=this.aipConfig.PREROLL_ELEM,this.aipConfig.PREROLL_CONTAINER.style.top="0",this.aipConfig.PREROLL_CONTAINER.style.left="0",this.aipConfig.PREROLL_CONTAINER.style.width="100%",this.aipConfig.PREROLL_CONTAINER.style.height="100%",this.aipConfig.PREROLL_CONTAINER.style.position=
"fixed",this.aipConfig.PREROLL_CONTAINER.style.zIndex="999996",this.aipConfig.PREROLL_CONTAINER.style.overflow="hidden",this.aipConfig.PREROLL_CONTAINER.className="";else{var a=document.getElementById("aipPrerollContainer");if("undefined"==typeof a||null==a)a=document.createElement("div"),a.id="aipPrerollContainer",this.aipConfig.PREROLL_ELEM.appendChild(a);this.aipConfig.PREROLL_CONTAINER=document.getElementById("aipPrerollContainer");try{var b=window.getComputedStyle(this.aipConfig.PREROLL_ELEM,
null).getPropertyValue("position");if(""==b||"static"==b)this.aipConfig.PREROLL_ELEM.style.position="relative"}catch(d){}try{var c=window.getComputedStyle(this.aipConfig.PREROLL_ELEM,null).getPropertyValue("z-index");if(""==c||isNaN(c))this.aipConfig.PREROLL_ELEM.style.zIndex="999996"}catch(d){}this.aipConfig.PREROLL_CONTAINER.style.width=this.aipConfig.AD_WIDTH+"px";this.aipConfig.PREROLL_CONTAINER.style.height=this.aipConfig.AD_HEIGHT+"px";this.aipConfig.PREROLL_ELEM.style.width=this.aipConfig.AD_WIDTH+
"px";this.aipConfig.PREROLL_ELEM.style.height=aiptag.settings.iHideBranding?this.aipConfig.AD_HEIGHT+"px":this.aipConfig.AD_HEIGHT+26+"px";this.aipConfig.AD_CENTERPLAYER&&(this.aipConfig.PREROLL_ELEM.style.top="0",this.aipConfig.PREROLL_ELEM.style.left="0",this.aipConfig.PREROLL_ELEM.style.bottom="0",this.aipConfig.PREROLL_ELEM.style.right="0",this.aipConfig.PREROLL_ELEM.style.position="fixed",this.aipConfig.PREROLL_ELEM.style.zIndex="999996",this.aipConfig.PREROLL_ELEM.style.margin="auto")}this.showLoading(!0);
aiptag.settings.iHideBranding||this.showBranding();this.aipConfig.PREROLL_CONTAINER.style.backgroundColor="#000000";aipAPItag.sdkLoaded()?this.startAd():(aipAPItag.log("Ads lib not ready yet"),aipAPItag.wait(100,7500,function(){return 1==aipAPItag.sdkBlocked||1==aipAPItag.sdkLoaded()}.bind(this),function(){aipAPItag.log("Ads lib ready after interval");this.startAd()}.bind(this),function(){aipAPItag.log("Ads lib failed to load after interval");this.aipComplete("adslib-load-failed")}.bind(this)))}else console.log("***WARNING*** PREROLL_ELEM does not exists, AD cant be played"),
this.aipComplete("preroll_elem-doesnt-exists")};aipPlayer.prototype.startAd=function(){1==aipAPItag.sdkBlocked?(aipAPItag.log("AD BLOCKED"),this.aipComplete("user-has-adblock"),this.aipConfig.AIP_BLOCKED&&this.aipConfig.AIP_BLOCKED(),aipAPItag.sendEvent("user-has-adblock")):(aipAPItag.log("Final vasturl="+this.aipConfig.AD_TAG),this.requestAd(this,this.aipConfig.AD_TAG,aipAPItag.log,!0))};
aipPlayer.prototype.aipRewardComplete=function(a,b){if(aipAPItag.aipRewardCompleteExec>=Date.now()-5E3)aipAPItag.log("Rewarded AD: aipRewardComplete called twice");else{aipAPItag.aipRewardCompleteExec=Date.now();clearTimeout(aipAPItag.completedTimeoutRewarded);try{googletag.destroySlots([aipAPItag.aipAPIrewardedSlot])}catch(c){}aiptag.settings.iForceRewardedAd?b?aiptag.settings.sRewardAdUnitVideoFallback?this.startPreRoll(aiptag.settings.sRewardAdUnitVideoFallback):(this.showLoading(!1),this.aipConfig.AIP_COMPLETE&&
this.aipConfig.AIP_COMPLETE(a)):(this.showLoading(!1),this.aipConfig.AIP_COMPLETE&&this.aipConfig.AIP_COMPLETE(a)):(this.showLoading(!1),this.aipConfig.AIP_REWARDEDCOMPLETE&&this.aipConfig.AIP_REWARDEDCOMPLETE(a))}};
aipPlayer.prototype.aipComplete=function(a){try{this.aipConfig.PREROLL_ELEM.style.display="none"}catch(b){}this.showLoading(!1);this.aipConfig.AIP_COMPLETE&&setTimeout(function(){aipAPItag.prerollSkipped&&(a="video-ad-skipped");this.aipConfig.AIP_COMPLETE(a)}.bind(this),300);this.aipConfig.AIP_REMOVE&&setTimeout(function(){aipAPItag.isInPage(this.aipConfig.PREROLL_CONTAINER)||1!=aipAPItag.sdkBlocked&&console.log("***WARNING*** PREROLL_CONTAINER is removed prematurely, please do not remove PREROLL_CONTAINER on AIP_COMPLETE, you can remove it on AIP_REMOVE");
this.aipConfig.AIP_REMOVE()}.bind(this),3E3);try{document.getElementById(aipThis.aipConfig.PREROLL_ELEM_ID).removeEventListener("click",handlePaused)}catch(b){}};
aipPlayer.prototype.showLoading=function(a,b){if(this.aipConfig.AD_FULLSCREEN||b)if(a){var c=document.getElementById("divFullscreenLoading");if("undefined"==typeof c||null==c)c=document.createElement("div"),c.id="divFullscreenLoading",c.style.overflow="hidden",c.style.position="fixed",c.style.zIndex="999997",c.style.margin="auto",c.style.top="0",c.style.left="0",c.style.bottom="0",c.style.right="0",c.style.width="100%",c.style.height="100%",c.style.backgroundColor="#000000",c.innerHTML='<img border="0" style="position: fixed;z-index: 999998;top: 50%;left: 50%;transform: translate(-50%, -50%);" src="//api.adinplay.com/libs/aiptag/assets/loader-red.gif" />',
document.getElementsByTagName("body")[0].appendChild(c)}else{c=document.getElementById("divFullscreenLoading");"undefined"!=typeof c&&null!=c&&(c=document.getElementById("divFullscreenLoading"),c.parentNode.removeChild(c));try{document.getElementById("aipLoadingTxt").style.display="none"}catch(d){}}else if(a)c=document.createElement("div"),c.id="divFullscreenLoading",c.style.overflow="hidden",c.style.position="absolute",c.style.top="0",c.style.left="0",c.style.bottom="0",c.style.right="0",c.style.zIndex=
"999997",c.style.width=this.aipConfig.AD_WIDTH+"px",c.style.height=this.aipConfig.AD_HEIGHT+"px",c.style.backgroundColor="#000000",c.innerHTML='<img border="0" style="position: absolute;z-index: 999998;top: 50%;left: 50%;transform: translate(-50%, -50%);" src="//api.adinplay.com/libs/aiptag/assets/loader-red.gif" />',this.aipConfig.PREROLL_ELEM.appendChild(c);else{c=document.getElementById("divFullscreenLoading");"undefined"!=typeof c&&null!=c&&(c=document.getElementById("divFullscreenLoading"),c.parentNode.removeChild(c));
try{document.getElementById("aipLoadingTxt").style.display="none"}catch(d){}}};aipPlayer.prototype.showSkipButton=function(){try{document.getElementById("aipVideoAdUiSkipButton").style.display="inline"}catch(a){}};
aipPlayer.prototype.showBranding=function(){var a=document.getElementById("aipBranding");if("undefined"==typeof a||null==a)a=document.createElement("div"),a.id="aipBranding",this.aipConfig.AD_FULLSCREEN?(a.style="position: fixed;bottom: 0;width: 100%;z-index: 999998;width: 100%;",document.getElementsByTagName("body")[0].appendChild(a)):(a.style="position: absolute;bottom: 0;width: 100%;z-index: 999998;width: "+this.aipConfig.AD_WIDTH+"px;",this.aipConfig.PREROLL_ELEM.appendChild(a));a.innerHTML='<div style="border-top: 1px solid #ffffff;min-height: 25px;background-color: #000000;position: relative;"><div id="aipLoadingTxt" style="text-align: left;display: inline-block;margin-top: 3px;"><span style="font-size: 16px;font-family: \'open sans\';font-weight: 100;color: #fff;padding-left: 5px;" id="loading-text-aip">'+
this.aipConfig.LOADING_TEXT+'<img style="margin-left: 10px;vertical-align: middle;" src="data:image/gif;base64,"/></span></div><button id="aipVideoAdUiSkipButton" style="display: none;border:0;background: rgba(0,0,0,0.8);color: #fff;cursor: pointer;font-size: 14px;"><div style="display: inline-block;font-size: 14px;vertical-align: middle;width: initial;">Skip Ad</div><div style="background-image: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAQAAABKfvVzAAAABGdBTUEAALGPC/xhBQAAAAJiS0dEAP+Hj8y/AAAAZElEQVQ4y+3SwQmDQBBGYRFy9mYLSRXWEyvRRtKBbdhDUoTH8HkVllX+u++48GD2zTTNTYiPrnhDXeBnyAT+Zo9EgNUrE9iMmQCLvhTas2jXWY8jvbNPP5OsU5L1my0uPY2bCjtXdo6mqRVtTgAAAABJRU5ErkJggg==);background-repeat: no-repeat;display: inline-block;height: 24px;width: 24px;margin-left: 2px;vertical-align: middle;"></div></button><span style="font-size: 16px;font-family: \'open sans\';font-weight: 100;color: #fff;padding-left: 5px;" id="loading-text-aip"></span><a style="margin-top: 6px;position: absolute;right: 5px;" target="_blank" href="http://www.adinplay.com/"><img style="vertical-align: top;position: relative;" id="aipLogo" src="data:image/png;base64," border="0" /></a></div></div>'};
aipPlayer.prototype.activeViewDetect=function(){var a=document.documentElement.clientHeight||document.body.clientHeight||window.innerHeight;if((document.documentElement.clientWidth||document.body.clientWidth||window.innerWidth)<this.aipConfig.AD_WIDTH||a<this.aipConfig.AD_HEIGHT)this.aipConfig.AD_FULLSCREEN=!0};
aipPlayer.prototype.requestAd=function(a,b,c,d){null==aipAPItag.aipAds&&(c("LOADED FIRST TIME"),aipAPItag.aipAds=new AipAds(a,a.aipConfig.PREROLL_CONTAINER,a.aipConfig.PREROLL_CONTAINER,d));try{aipAPItag.aipAds.requestAds(b,c),a.aipConfig.PREROLL_ELEM.style.display="block"}catch(g){c("EXCEPTION",{name:g.name,message:g.message,stack:g.stack}),a.aipComplete("ad-exception")}};
function AipAds(a,b,c,d){function g(){aipAPItag.sendEvent("video-ad-paused");try{document.getElementById(a.aipConfig.PREROLL_ELEM_ID).addEventListener("click",e)}catch(E){}}function e(){aipAPItag.sendEvent("video-ad-resumed-forced");f.resume()}function h(){aipAPItag.sendEvent("video-ad-resumed");try{document.getElementById(a.aipConfig.PREROLL_ELEM_ID).removeEventListener("click",e)}catch(E){}}function l(a){m("EXCEPTION",{name:a.name,message:a.message,stack:a.stack})}function C(a){var b="",c="",d=
"";try{b=a.getAd().getContentType(),c=a.getAd().getMinSuggestedDuration(),d=a.getAd().getCreativeId()}catch(F){l(F)}m("CONTENT_PAUSE_REQUESTED",{contentType:b,creativeId:d,minSuggestedDuration:c})}function D(b){w();c.style.display="block";a.showLoading(!1);a.aipConfig.AIP_STARTED&&a.aipConfig.AIP_STARTED();try{aipAPItag.forceRedraw(document.getElementById(a.aipConfig.PREROLL_ELEM_ID))}catch(t){}if(d)try{m("MediaUrl: "+b.getAd().getMediaUrl()+"; AdvertiserName: "+b.getAd().getAdvertiserName()+"; Description: "+
b.getAd().getDescription()+"; Title: "+b.getAd().getTitle())}catch(t){l(t)}m("STARTED");aipAPItag.sendEvent("video-ad-started");aiptag.settings.iSkipButtonTimeout&&(aipAPItag.showSkipButtonTimer=setTimeout(function(){a.showSkipButton();try{document.getElementById("aipVideoAdUiSkipButton").onclick=function(){n.contentComplete();f.destroy();m("CONTENT_RESUME_REQUESTED");p=!1;r("video-ad-completed");aipAPItag.sendEvent("video-ad-removed")}}catch(t){}},aiptag.settings.iSkipButtonTimeout))}function v(){n.contentComplete();
f&&f.destroy();m("CONTENT_RESUME_REQUESTED");p=!1;r("video-ad-completed");aipAPItag.sendEvent("video-ad-removed")}function z(b){w();m(b.getError());n.contentComplete();f&&f.destroy();var c=(new Date).getTime()-B;1012==b.getError().getErrorCode()&&0<=c&&800>c?(m("AD BLOCKED",{timeElapsed:c}),a.aipConfig.AIP_BLOCKED&&a.aipConfig.AIP_BLOCKED(),aipAPItag.sendEvent("user-has-adblock"),b="user-has-adblock"):b.getError().getErrorCode()==google.ima.AdError.ErrorCode.VAST_EMPTY_RESPONSE||901==b.getError().getErrorCode()&&
b.getError().getInnerError()&&"Error: No ads available"==b.getError().getInnerError().message?(m("NO ADS",{errorCode:b.getError().getErrorCode(),message:b.getError().getMessage(),innerError:b.getError().getInnerError(),vastErrorCode:b.getError().getVastErrorCode(),timeElapsed:c}),a.aipConfig.AIP_NOADS&&a.aipConfig.AIP_NOADS(),aipAPItag.sendEvent("video-ad-empty"),b="video-ad-empty"):(m("ERROR",{errorCode:b.getError().getErrorCode(),message:b.getError().getMessage(),innerError:b.getError().getInnerError(),
vastErrorCode:b.getError().getVastErrorCode(),timeElapsed:c}),a.aipConfig.AIP_NOADS&&a.aipConfig.AIP_NOADS(),aipAPItag.sendEvent("video-ad-error"),b="video-ad-error");p=!1;r(b)}function q(){x=!0;p=!1;n.contentComplete();f&&f.destroy();m("TIMEOUT");r("video-ad-timeout");aipAPItag.sendEvent("video-ad-timeout")}function w(){u&&(clearTimeout(u),u=null)}function r(b){try{clearTimeout(aipAPItag.completedTimeoutPreroll)}catch(A){}if(aiptag.settings.iSkipButtonTimeout)try{clearTimeout(aipAPItag.showSkipButtonTimer)}catch(A){}try{var c=
document.getElementById("aipBranding");if("undefined"!=typeof c&&null!=c){var d=document.getElementById("aipBranding");d.parentNode.removeChild(d)}}catch(A){}w();a.aipComplete(b)}function y(){a.aipConfig.AD_FULLSCREEN?(windowWidth=document.documentElement.clientWidth||document.body.clientWidth||window.innerWidth,windowHeight=document.documentElement.clientHeight||document.body.clientHeight||window.innerHeight):(windowWidth=b.offsetWidth,windowHeight=b.offsetHeight);return{adWidth:windowWidth,adHeight:windowHeight}}
var n,f,p,B,u,x,m=function(){};window.addEventListener("error",function(a){if(p)try{m("WINDOW_EXCEPTION",{name:"WindowErrorListener: "+a.error.toString(),message:a.error.toString(),stack:a.error.stack})}catch(t){}});(function(){var d=new google.ima.AdDisplayContainer(c);d.initialize();n=new google.ima.AdsLoader(d);n.getSettings().setVpaidMode(google.ima.ImaSdkSettings.VpaidMode.INSECURE);n.addEventListener(google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED,function(c){function d(a){return function(){"COMPLETE"==
a&&(aipAPItag.sendEvent("video-ad-completed"),aipAPItag.completedTimeoutPreroll=setTimeout(v,1500));"CLICK"==a&&aipAPItag.sendEvent("video-ad-clicked");"USER_CLOSE"==a&&aipAPItag.sendEvent("video-ad-close");"LOADED"==a&&(aipAPItag.sendEvent("video-ad-loaded"),aipAPItag.prerollSkipped=!1);"SKIPPED"==a&&(aipAPItag.sendEvent("video-ad-skipped"),aipAPItag.prerollSkipped=!0);if("SKIPPABLE_STATE_CHANGED"==a&&aiptag.settings.iSkipButtonTimeout)try{clearTimeout(aipAPItag.showSkipButtonTimer),document.getElementById("aipVideoAdUiSkipButton").style.display=
"none"}catch(H){}m(a);aipAPItag.log("Preroll status: "+a)}}if(!x){var e=new google.ima.AdsRenderingSettings;e.loadVideoTimeout=12E3;f=c.getAdsManager(b,e);f.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,z);f.addEventListener(google.ima.AdEvent.Type.CONTENT_PAUSE_REQUESTED,C);f.addEventListener(google.ima.AdEvent.Type.CONTENT_RESUME_REQUESTED,v);f.addEventListener(google.ima.AdEvent.Type.STARTED,D);f.addEventListener(google.ima.AdEvent.Type.SKIPPED,d("SKIPPED"));f.addEventListener(google.ima.AdEvent.Type.CLICK,
d("CLICK"));f.addEventListener(google.ima.AdEvent.Type.PAUSED,g);f.addEventListener(google.ima.AdEvent.Type.RESUMED,h);f.addEventListener(google.ima.AdEvent.Type.FIRST_QUARTILE,d("FIRST_QUARTILE"));f.addEventListener(google.ima.AdEvent.Type.MIDPOINT,d("MIDPOINT"));f.addEventListener(google.ima.AdEvent.Type.THIRD_QUARTILE,d("THIRD_QUARTILE"));f.addEventListener(google.ima.AdEvent.Type.LOADED,d("LOADED"));f.addEventListener(google.ima.AdEvent.Type.COMPLETE,d("COMPLETE"));f.addEventListener(google.ima.AdEvent.Type.USER_CLOSE,
d("USER_CLOSE"));f.addEventListener(google.ima.AdEvent.Type.SKIPPABLE_STATE_CHANGED,d("SKIPPABLE_STATE_CHANGED"));try{var n=y();if(a.aipConfig.AD_FULLSCREEN){var q=document.documentElement.clientWidth||document.body.clientWidth||window.innerWidth,p=document.documentElement.clientHeight||document.body.clientHeight||window.innerHeight;aiptag.settings.iHideBranding||(p-=26);f.init(q,p,google.ima.ViewMode.FULLSCREEN)}else f.init(n.adWidth,n.adHeight,google.ima.ViewMode.NORMAL);f.start()}catch(G){l(G)}}});
n.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,z)})();window.addEventListener("resize",function(){if(f&&p){var b=y();a.aipConfig.AD_FULLSCREEN?f.resize(document.documentElement.clientWidth||document.body.clientWidth||window.innerWidth,document.documentElement.clientHeight||document.body.clientHeight||window.innerHeight,google.ima.ViewMode.FULLSCREEN):f.resize(b.adWidth,b.adHeight,google.ima.ViewMode.NORMAL)}});this.requestAds=function(a,b){m=b;B=(new Date).getTime();var c=new google.ima.AdsRequest;
c.adTagUrl=a;var d=y();c.linearAdSlotWidth=d.adWidth;c.linearAdSlotHeight=d.adHeight;c.nonLinearAdSlotWidth=d.adWidth;c.nonLinearAdSlotHeight=d.adHeight;c.forceNonLinearFullSlot=!0;c.setAdWillAutoPlay(!1);c.setAdWillPlayMuted(!1);n.requestAds(c);u=setTimeout(q,15E3);x=!1;p=!0}}aipAPItag=new aipAPI;aipAPItag.initGPT();aipAPItag.setCurrency();aipAPItag.detectBlockedAds();aipAPItag.initGDPR();